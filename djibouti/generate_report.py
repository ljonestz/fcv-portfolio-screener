...
<div class="page-wrap">
  ...
  <div class="report-section" id="redflags">
    ...
    <p><strong>RF3 — OP 7.30 Weakly Handled (18%).</strong> Four projects trigger this flag, reflecting weak treatment of involuntary resettlement and the rights of marginalised communities. This is a live concern in Djibouti given the Afar and Issa-Somali pastoral and agro-pastoral communities whose land use patterns do not align neatly with formal tenure systems. Infrastructure operations and urban development projects in particular need to account for customary land rights and displacement risks — an area where a small but significant share of the portfolio falls short.</p>
