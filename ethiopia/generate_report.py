...
<div class="page-wrap">
  ...
  <div class="report-section" id="redflags">
    ...
    <p><strong>RF2 — Missing Distributional Analysis (36%)</strong> and <strong>RF3 — OP 7.30 Weakly Handled (36%)</strong> each affect roughly a third of the portfolio. RF2 is most relevant for DPF and P4R instruments, where fiscal or subsidy policy changes have distributional consequences that are difficult to reverse; without ex-ante distributional analysis, these operations risk worsening inequality across ethnic or regional lines. RF3 reflects the treatment of involuntary resettlement and pastoralist communities — a live concern given Ethiopia's agro-pastoralist lowlands, large infrastructure programmes, and the displacement legacy of the Tigray conflict.</p>
