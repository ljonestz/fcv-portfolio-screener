...
<div class="page-wrap">
  ...
  <div class="report-section" id="redflags">
    ...
    <p><strong>RF1 — Unmitigated Conflict Risk (2%)</strong> and <strong>RF3 — OP 7.30 Weakly Handled (2%)</strong> each affect a single project. The near-zero RF1 rate is, in Somalia's case, more credible than in other FCV portfolios. The portfolio-average D2 score (Do No Harm and Conflict Risk) of 6.2/10 — approaching the 'Substantially Addressed' threshold — indicates that most projects engage meaningfully with conflict risk analysis and propose specific mitigation measures. The one RF1 trigger therefore appears to be a genuine outlier rather than evidence of systematic under-reporting.</p>
